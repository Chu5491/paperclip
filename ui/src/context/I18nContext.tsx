...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "issueDialog.newSubIssue": "New sub-issue",
    ...
    "issueDialog.createSubIssue": "Create Sub-Issue",
  ...
  ko: {
    ...
    "issueDialog.newSubIssue": "새 하위 이슈",
    ...
    "issueDialog.createSubIssue": "하위 이슈 생성",
  ...
  ja: {
    ...
    "issueDialog.newSubIssue": "新しいサブイシュー",
    ...
    "issueDialog.createSubIssue": "サブイシューを作成",
