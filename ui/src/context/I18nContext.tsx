...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "issueDialog.addReviewerOrApprover": "Add reviewer or approver",
    "issueDialog.reviewer": "Reviewer",
    "issueDialog.approver": "Approver",
    "issueDialog.subIssueOf": "Sub-issue of",
    "issueDialog.executionWorkspace": "Execution workspace",
    "issueDialog.chooseExistingWorkspace": "Choose an existing workspace",
    "issueDialog.modelLane": "Model lane",
    "issueDialog.modelLaneDefaultDesc": "Runs on the agent's primary model.",
    "issueDialog.modelLaneOverrideDesc": "Override the model and effort for this issue only.",
    "issueDialog.model": "Model",
    "issueDialog.defaultModel": "Default model",
    "issueDialog.thinkingEffort": "Thinking effort",
    "issueDialog.enableChrome": "Enable Chrome (--chrome)",
    "issueDialog.documents": "Documents",
    "issueDialog.removeDocument": "Remove document",
    "issueDialog.attachments": "Attachments",
    "issueDialog.removeAttachment": "Remove attachment",
    "issueDialog.creatingIssue": "Creating issue...",

    "issuesList.subIssuesProgress": "Sub-issues completion progress",
    "issuesList.noActiveSubIssues": "No active sub-issues",
    "issuesList.allSubIssuesDone": "All sub-issues done",
    "issuesList.noActionableSubIssues": "No actionable sub-issues",
    "issuesList.listView": "List view",
    "issuesList.boardView": "Board view",
    "issuesList.columnsVisibility": "Choose which issue columns stay visible",
    "issuesList.sort": "Sort",
    "issuesList.group": "Group",
    "issuesList.paused": "Paused",

    "layout.closeSidebar": "Close sidebar",

    "sidebar.openAccountMenu": "Open account menu",
  ...
  ko: {
    ...
    "issueDialog.addReviewerOrApprover": "리뷰어 또는 승인자 추가",
    "issueDialog.reviewer": "리뷰어",
    "issueDialog.approver": "승인자",
    "issueDialog.subIssueOf": "상위 이슈",
    "issueDialog.executionWorkspace": "실행 워크스페이스",
    "issueDialog.chooseExistingWorkspace": "기존 워크스페이스 선택",
    "issueDialog.modelLane": "모델 레인",
    "issueDialog.modelLaneDefaultDesc": "에이전트 기본 모델로 실행됩니다.",
    "issueDialog.modelLaneOverrideDesc": "이 이슈에만 모델과 사고 단계를 재정의합니다.",
    "issueDialog.model": "모델",
    "issueDialog.defaultModel": "기본 모델",
    "issueDialog.thinkingEffort": "사고 단계",
    "issueDialog.enableChrome": "Chrome 활성화 (--chrome)",
    "issueDialog.documents": "문서",
    "issueDialog.removeDocument": "문서 제거",
    "issueDialog.attachments": "첨부파일",
    "issueDialog.removeAttachment": "첨부파일 제거",
    "issueDialog.creatingIssue": "이슈 생성 중...",

    "issuesList.subIssuesProgress": "하위 이슈 완료 진행률",
    "issuesList.noActiveSubIssues": "활성 하위 이슈가 없습니다",
    "issuesList.allSubIssuesDone": "모든 하위 이슈 완료",
    "issuesList.noActionableSubIssues": "처리할 하위 이슈가 없습니다",
    "issuesList.listView": "리스트 보기",
    "issuesList.boardView": "보드 보기",
    "issuesList.columnsVisibility": "표시할 이슈 컬럼 선택",
    "issuesList.sort": "정렬",
    "issuesList.group": "그룹",
    "issuesList.paused": "일시중지됨",

    "layout.closeSidebar": "사이드바 닫기",

    "sidebar.openAccountMenu": "계정 메뉴 열기",
    "sidebar.viewProfile": "프로필 보기",
    "sidebar.editProfile": "프로필 편집",
    "sidebar.instanceSettings": "인스턴스 설정",
    "sidebar.agentPausedByBudget": "예산 한도로 에이전트 일시중지됨",
    "sidebar.editAgent": "에이전트 편집",
    "sidebar.projectPausedByBudget": "예산 한도로 프로젝트 일시중지됨",
  },
  ja: {
    ...
    "issueDialog.addReviewerOrApprover": "レビュー担当者または承認者を追加",
    "issueDialog.reviewer": "レビュー担当者",
    "issueDialog.approver": "承認者",
    "issueDialog.subIssueOf": "サブイシュー対象",
    "issueDialog.executionWorkspace": "実行ワークスペース",
    "issueDialog.chooseExistingWorkspace": "既存のワークスペースを選択",
    "issueDialog.modelLane": "モデルレーン",
    "issueDialog.modelLaneDefaultDesc": "エージェントのプライマリモデルで実行されます。",
    "issueDialog.modelLaneOverrideDesc": "このイシューのみモデルとエフォートを上書きします。",
    "issueDialog.model": "モデル",
    "issueDialog.defaultModel": "デフォルトモデル",
    "issueDialog.thinkingEffort": "思考エフォート",
    "issueDialog.enableChrome": "Chromeを有効化 (--chrome)",
    "issueDialog.documents": "ドキュメント",
    "issueDialog.removeDocument": "ドキュメントを削除",
    "issueDialog.attachments": "添付ファイル",
    "issueDialog.removeAttachment": "添付ファイルを削除",
    "issueDialog.creatingIssue": "イシューを作成中...",

    "issuesList.subIssuesProgress": "サブイシューの完了進捗",
    "issuesList.noActiveSubIssues": "アクティブなサブイシューはありません",
    "issuesList.allSubIssuesDone": "すべてのサブイシューが完了しました",
    "issuesList.noActionableSubIssues": "対応すべきサブイシューはありません",
    "issuesList.listView": "リスト表示",
    "issuesList.boardView": "ボード表示",
    "issuesList.columnsVisibility": "表示するイシュー列を選択",
    "issuesList.sort": "並び替え",
    "issuesList.group": "グループ",
    "issuesList.paused": "一時停止中",

    "layout.closeSidebar": "サイドバーを閉じる",

    "sidebar.openAccountMenu": "アカウントメニューを開く",
    "sidebar.viewProfile": "プロフィールを表示",
    "sidebar.editProfile": "プロフィールを編集",
    "sidebar.instanceSettings": "インスタンス設定",
    "sidebar.agentPausedByBudget": "予算によりエージェントを一時停止",
    "sidebar.editAgent": "エージェントを編集",
    "sidebar.projectPausedByBudget": "予算によりプロジェクトを一時停止",
  },
};
